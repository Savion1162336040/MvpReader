...
public class SystemUtil {
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) MvpApplication.instance.getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static Uri saveBitmapToFile(Context context, String url, Bitmap bitmap, View container, boolean isShare) {
        ...
        File fileDir = new File(Constant.IMG_PATH);
        if (!fileDir.exists()) {
            fileDir.mkdirs();
        }
    ...
    public static int dp2px(float dpValue) {
        final float scale = MvpApplication.instance.getResources().getDisplayMetrics().density;
        return (int) (dpValue * scale + 0.5f);
    }
